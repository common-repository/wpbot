...
{ 
	...
	$instance_bot2->upgrade_link = "https://www.quantumcloud.com/products/chatbot-addons/";
	...
	$instance_bot2->plugin_slug = 'wpbot'; //Plugin Slug. i.e. Folder Name
	$instance_bot2->plugin_main_file = 'wpbot-chat-history-addon.php'; //Primary file of the pluign
	//$instance_bot2->plugin_menu_slug = 'wbcs-botsessions-page'; //Main Menu Slug
